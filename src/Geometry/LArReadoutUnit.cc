...
LArReadoutUnit::LArReadoutUnit(unsigned int id, HitType view, float referenceCoordinate, float pitch, const CartesianVector &unitCenter,
    const CartesianVector &unitSize, const LArReadoutChannel::ReadoutChannels &readoutChannels) :
    m_id(id),
    m_view(view),
