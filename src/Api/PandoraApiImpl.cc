...
StatusCode PandoraApiImpl::SetCaloHitToMCParticleRelationship(
    const void *const pCaloHitParentAddress, const void *const pMCParticleParentAddress, const InputFloat mcParticleWeight) const
{
...
StatusCode PandoraApiImpl::SetTrackToMCParticleRelationship(
    const void *const pTrackParentAddress, const void *const pMCParticleParentAddress, const InputFloat mcParticleWeight) const
{
