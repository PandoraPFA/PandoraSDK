...
private:
    ...
    DetectorGapList             m_detectorGapList;            ///< List of all gaps in the active detector volume
    DetectorGapList             m_persistentDetectorGapList;  ///< List of persistent gaps in the active detector volume
